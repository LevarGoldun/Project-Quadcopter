...
# a řešiče odeint, která vypočítá nové stavy systému na nějakém intervalu (t, t+dt) ve smyčce for !!!
...
for time in sim_time:
    ...
    # Funguje oběma způsoby, ale globální proměnné jsou potřeba jen k implementaci PID přes funkci...
...
# Plot
plt.plot(t_sol, y_sol[:, 0])  # Graf je mnohem bližší k Simulink než předchozí soubory
plt.grid(True)
