...
open_system('tcp_client_simulink.slx');
pause(1)
...
while count<120 % just run for 120 steps for demo
    ...
    set_param('tcp_client_simulink/K1','Gain',num2str(data1));
    set_param('tcp_client_simulink/K2','Gain',num2str(data2));
    set_param('tcp_client_simulink/K3','Gain',num2str(data3));
    set_param('tcp_client_simulink/K4','Gain',num2str(data4));
...
toc
set_param('tcp_client_simulink/K1','Gain',num2str(0));
set_param('tcp_client_simulink/K2','Gain',num2str(0));
set_param('tcp_client_simulink/K3','Gain',num2str(0));
set_param('tcp_client_simulink/K4','Gain',num2str(0));
