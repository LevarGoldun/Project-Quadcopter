...
for i=0:timestep:simtime
    ...
    % TCP sending
    m1 = out.motor_signals.Data(end,1);
    m2 = out.motor_signals.Data(end,2);
    m3 = out.motor_signals.Data(end,3);
    m4 = out.motor_signals.Data(end,4);

    data_to_send = struct('m1', m1, 'm2', m2, 'm3', m3, 'm4', m4);
