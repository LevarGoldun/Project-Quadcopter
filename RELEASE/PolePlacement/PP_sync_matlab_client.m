...
% Verze pro rizeni Pole Placement

%===================!!! Kontrola verze Simulink !!!========================
v = version;
% if contains(v, 'R2024a')
%     simulink_file_name = 'PP_simulink_control_client_2024a'; %verze 2024a    
% elseif contains(v, 'R2024b')
%     simulink_file_name = 'PP_simulink_control_client'; %verze 2024b (autor)
% else
%     disp('Save the file async_simulink_control_client.slx to your version')
% end
if contains(v, 'R2024a')
    simulink_file_name = 'PP_simulink_control_client_2_2024a'; %verze 2024a    
elseif contains(v, 'R2024b')
    simulink_file_name = 'PP_simulink_control_client_2'; %verze 2024b (autor)
else
    disp('Save the file async_simulink_control_client.slx to your version')
end
clear v
...
% init_int_ref_m = -kimot\(kpmot*xss+ussm); % pro vstup otacky^2
