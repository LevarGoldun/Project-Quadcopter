...
% Verze pro rizeni Pole Placement, VERZE OTACKY

% od 16.05 -> zmena poradi vymenu dat; verze pro Sily/Moment ve zvlastnim
% souboru

%===================!!! Kontrola verze Simulink !!!========================
v = version;
if contains(v, 'R2024a')
    simulink_file_name = 'PP_simulink_Otacky_2024a'; %verze 2024a    
elseif contains(v, 'R2024b')
    simulink_file_name = 'PP_simulink_Otacky'; %verze 2024b (autor)
else
...
Ac = LinSystem.Ac;
Bc = LinSystem.Bc;
Bmc = LinSystem.Bmc; % matice pro vstupy otacky^2 do pozorovatele
Cc = LinSystem.Cc;
Dc = LinSystem.Dc;
