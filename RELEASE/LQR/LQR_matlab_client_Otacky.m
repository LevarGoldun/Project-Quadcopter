...
% Verze pro rizeni pomoci LQR, VERZE OTACKY
...
if contains(v, 'R2024a')
    simulink_file_name = 'LQR_simulink_Otacky_2024a'; %verze 2024a    
elseif contains(v, 'R2024b')
    simulink_file_name = 'LQR_simulink_Otacky'; %verze 2024b (autor)
else
